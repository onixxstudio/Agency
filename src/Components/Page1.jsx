...
<div ref={bg1} className=' absolute h-screen w-full z-[-1]'></div>
    ...
    <div ref={img_container} className='perspective  text-white bg-[#1E1E1C] h-[100vh] w-[100%] items-center justify-center flex'>
      <img ref={img} src="../src/assets/Ocean.jpg" className='image w-full h-screen' />
...
<div id='col-1' className='flex mb-16 pl-20 gap-16'>
  <img src="../src/assets/1.webp" className='w-[16%] h-80 object-cover' alt="" />
  <img src="../src/assets/2.webp" className='h-1/2 object-cover w-[32%]' alt="" />
  <img src="../src/assets/3.webp" className='max-300 ml-56 w-[28%]' alt="" />
</div>

<div id='col-2' className='flex mt-56 justify-between p-24'>
<img src="../src/assets/3.webp" className='w-[25%]' alt="" />
<div className='h-12 w-12 bg-red-300'></div>
<img src="../src/assets/Ocean.jpg" className='w-[25%] last' alt="" />
